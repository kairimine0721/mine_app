...
def run_simulation(num, random)
  ...
  posx = 0.0 #cm
  posy = 0.0 #cm
  posz = 12.505 #cm 10 + 2.405 + 0.1
  radius = 0.00001 #cm 5.0
  
 dirx = 0
 diry = 0
 dirz = -1.0
 thetamax = 0.1 #0.26179933
#  thetamax = 0.5

  output = "ps_without_collimator_ene#{energy}_posx#{posx}cm_posy#{posy}cm_poz#{posz}cm_seed#{random}.root"
