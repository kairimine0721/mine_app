...
ANLStatus NucleusPrimaryGen_2d_phantom::mod_bgnrun()
{
  ...
  ANLStatus NucleusPrimaryGen_2d_phantom::mod_ana()
  {
...
G4ThreeVector NucleusPrimaryGen_2d_phantom::samplePosition()
{
  ...
  m_Position0.setX(posx*cm);
  m_Position0.setY(posy*cm);
  return m_Position0;
}
